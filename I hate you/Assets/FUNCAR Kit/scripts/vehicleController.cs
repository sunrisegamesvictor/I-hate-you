...
public class vehicleController : MonoBehaviour {
	...
	{
		//input//
		//Debug.Log(SteeringWheel.instance.GetInput());
		float wheelSt = SteeringWheel.instance.GetInput ();
		if (wheelSt != 0)
		{
			inputX = Mathf.SmoothStep(inputX,wheelSt,(steering*0.2f)*Time.deltaTime);
		} 
		else 
		{
		...
		if (UIControl.instance.goAxis != 0) 
		{
			inputY = UIControl.instance.goAxis;
		}
		else 
		{
